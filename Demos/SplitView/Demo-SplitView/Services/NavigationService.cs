            ...
            if (page != null)
            {
                ...
                if (dataContext != null)
                {
                    ...
                    var method = dataContext.GetType()
                        .GetRuntimeMethod("OnNavigatedFrom", new[] { typeof(Dictionary<string, object>), typeof(Boolean) });
                    if (method != null)
                    {
        ...
        void NavigateTo(NavigationMode mode, string parameter)
        {
            ...
            if (page != null)
            {
                ...
                if (dataContext != null)
                {
                    // navigationService will not depend on Mvvm namespace
                    var method = dataContext.GetType()
                        .GetRuntimeMethod("OnNavigatedTo", new[] { typeof(string), typeof(NavigationMode), typeof(Dictionary<string, object>) });
                    if (method != null)
                    {
                        // TODO: get existing state
